export default function TerminalPage() {
    return(
        <>
        <h1>Terminal Stuff</h1>
        <p>IPs - ssh, blocking  - firewalls- , ddosing, //access web page, access others</p>
        <p>searching/finding things</p>
        <p>/users and groups -permissions, etc, </p>
